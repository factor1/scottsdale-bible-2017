...
<div class="medium-9 medium-centered columns">
	...
	<div class="centered">
		<h3></h3>
		<p class="vip"><span class="emphasis"> Executive Producer</span> Troy Peterson </p>
		<p class="vip"><span class="emphasis">Co-producers</span> Julia Hamilton, Tammy Reimche </p>
		<p class="vip"><span class="emphasis">Production Director</span>  Nick Palomo </p>
		<p class="vip"><span class="emphasis">Instrumental Director and Arranger</span> Joe Bubar </p>
		<p class="vip"><span class="emphasis">Audio Engineer</span> Kevin Anvik </p>
		<p class="vip"><span class="emphasis">Video and Lighting Design</span> Josh Rothrock </p>
		<p class="vip"><span class="emphasis">Video Editor</span> Jesse Lopez </p>
		<p><span class="emphasis">Graphic Design </span> Mike Oliveros </p>
	</div>
</div>
</div>
