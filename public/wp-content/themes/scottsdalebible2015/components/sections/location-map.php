...
<section class="location-map">
    <div class="map-container" data-key="<?php echo GOOGLE_API_KEY; ?>" data-height="500" data-zoom="11" data-lat="<?php echo round($campuses[0]->location['lat'],3); ?>" data-lng="<?php echo round($campuses[0]->location['lng'],3); ?>">
    </div>
