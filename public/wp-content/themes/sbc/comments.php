...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			...
			<cite><?php comment_author_link() ?></cite> wrote:
...
<?php if ('open' == $post->comment_status) : ?>
<p>We reserve the right to edit responses and post all appropriate messages for everyone to read.</p>
...
<label for="author"><small>Name <?php if ($req) echo "(required; published with your permission only)"; ?></small></label></p>
